...
namespace Imgeneus.World.Game.Skills
{
    public class Skill
    {
        ...
        /// </summary>
        public bool IsPassive => TypeAttack == TypeAttack.Passive && Type != TypeDetail.Buff && Type != TypeDetail.BlockMagicAttack && Type != TypeDetail.Untouchable && Type != TypeDetail.Stealth && Type != TypeDetail.Sleep && Type != TypeDetail.TownPortal && Type != TypeDetail.BlockShootingAttack;
