...
namespace Imgeneus.World.Tests.ItemTests
{
    public class PotionTest : BaseTest
    {
        ...
        public void EtainPotionTest()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, EtainPotion.Type, EtainPotion.TypeId));
        ...
        public void RedAppleTest()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, RedApple.Type, RedApple.TypeId));
            character.InventoryManager.TryUseItem(1, 0);
        ...
        public void RedAndGreenAppleTest()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, RedApple.Type, RedApple.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, GreenApple.Type, GreenApple.TypeId));
