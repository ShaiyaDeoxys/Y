...
namespace Imgeneus.World.Tests.ItemTests
{
    public class GenerateAnotherItemTest : BaseTest
    {
        ...
        public async Task ShouldGenerateAnotherItem()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, BoxWithApples.Type, BoxWithApples.TypeId));
        ...
        public async Task FullInventoryShouldNotGenerateAnotherItem()
        {
            ...
            var box = character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, BoxWithApples.Type, BoxWithApples.TypeId));
            Assert.NotNull(box);
