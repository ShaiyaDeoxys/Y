...
namespace Imgeneus.World.Tests.ItemTests
{
    public class CraftNameTest : BaseTest
    {
        ...
        {
            var item = new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, JustiaArmor.Type, JustiaArmor.TypeId);
        ...
        {
            var item = new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, new DbCharacterItems()
            {
                Craftname = craftName
            });
