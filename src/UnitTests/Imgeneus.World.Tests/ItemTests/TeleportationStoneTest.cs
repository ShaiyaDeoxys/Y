...
namespace Imgeneus.World.Tests.ItemTests
{
    public class TeleportationStoneTest : BaseTest
    {
        ...
        public async Task NotPossibleToTeleportIfNoSavedPlaceIndex()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, TeleportationStone.Type, TeleportationStone.TypeId));
        ...
        public async Task BlueDragonCharmIncreasesMaxTeleportPlaces()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, BlueDragonCharm.Type, BlueDragonCharm.TypeId));
