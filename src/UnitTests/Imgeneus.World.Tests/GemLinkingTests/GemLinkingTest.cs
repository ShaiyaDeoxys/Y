...
namespace Imgeneus.World.Tests.GemLinkingTests
{
    public class GemLinkingTest : BaseTest
    {
        ...
        public void GemAdd_LinkWithPerfectHammer()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, JustiaArmor.Type, JustiaArmor.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, PerfectLinkingHammer.Type, PerfectLinkingHammer.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, Gem_Str_Level_1.Type, Gem_Str_Level_1.TypeId));
        ...
        public void GemAdd_FailBreakItem()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, JustiaArmor.Type, JustiaArmor.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, Gem_Str_Level_7.Type, Gem_Str_Level_7.TypeId));
        ...
        public void GemAdd_ItemMustHaveFreeSlots()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, WaterArmor.Type, WaterArmor.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, PerfectLinkingHammer.Type, PerfectLinkingHammer.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, Gem_Str_Level_1.Type, Gem_Str_Level_1.TypeId));
        ...
        public void GemAdd_LuckyCharmSavesItem()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, JustiaArmor.Type, JustiaArmor.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, Gem_Str_Level_7.Type, Gem_Str_Level_7.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, LuckyCharm.Type, LuckyCharm.TypeId));
        ...
        public void GemRemove_ExtractWithPerfectHammer()
        {
            ...
            var armorItem = new Item(databasePreloader.Object, enchantConfig.Object, JustiaArmor.Type, JustiaArmor.TypeId)
            {
                Gem1 = new Gem(databasePreloader.Object, Gem_Str_Level_1.TypeId, 0)
            };

            character.InventoryManager.AddItem(armorItem);
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, PerfectExtractingHammer.Type, PerfectExtractingHammer.TypeId));
        ...
        public void Gem_Absorption()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, JustiaArmor.Type, JustiaArmor.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, PerfectLinkingHammer.Type, PerfectLinkingHammer.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, Gem_Absorption_Level_4.Type, Gem_Absorption_Level_4.TypeId));
        ...
        public void Gem_AbsorptionAreStackable()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, PerfectLinkingHammer.Type, PerfectLinkingHammer.TypeId));
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, Gem_Absorption_Level_5.Type, Gem_Absorption_Level_5.TypeId));
