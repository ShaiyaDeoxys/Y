...
namespace Imgeneus.World.Tests.PartyTests
{
    public class RaidTest : BaseTest
    {
        ...
        public void Raid_DropToGroup_NoPlaceInInventory()
        {
            ...
            {
                character1.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, WaterArmor.Type, WaterArmor.TypeId));
                character2.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, WaterArmor.Type, WaterArmor.TypeId));
            }
