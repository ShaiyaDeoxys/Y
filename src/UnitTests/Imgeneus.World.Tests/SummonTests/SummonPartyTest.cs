...
namespace Imgeneus.World.Tests.SummonTests
{
    public class SummonPartyTest : BaseTest
    {
        ...
        public void DoNotUseSummonItemWithNoParty()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, PartySummonRune.Type, PartySummonRune.TypeId));
        ...
        public void SummonItemShouldBeUsed()
        {
            ...
            var summonItem = character1.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, PartySummonRune.Type, PartySummonRune.TypeId));
