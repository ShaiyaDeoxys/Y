...
namespace Imgeneus.World.Tests.CharacterTests
{
    public class CharacterVehicleTest : BaseTest
    {
        ...
        public void CharacterMountTest()
        {
            ...
            character.InventoryManager.AddItem(new Item(databasePreloader.Object, enchantConfig.Object, itemCreateConfig.Object, HorseSummonStone.Type, HorseSummonStone.TypeId));
