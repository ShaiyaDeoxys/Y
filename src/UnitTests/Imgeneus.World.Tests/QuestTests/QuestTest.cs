...
namespace Imgeneus.World.Tests.QuestTests
{
    public class QuestTest : BaseTest
    {
        ...
        {
            var questsManager = new QuestsManager(new Mock<ILogger<QuestsManager>>().Object, definitionsPreloader.Object, new Mock<IMapProvider>().Object, gameWorldMock.Object, databaseMock.Object, new Mock<IPartyManager>().Object, new Mock<IInventoryManager>().Object, databasePreloader.Object, enchantConfig.Object, new Mock<ILevelingManager>().Object);
        ...
        public void FarmItemsAreCheckedQuest()
        {
            ...
            items.TryAdd((1, 0), new Item(databasePreloader.Object, enchantConfig.Object, Bartering.RewardItems[0].Type, Bartering.RewardItems[0].TypeId, Bartering.RewardItems[0].Count));
