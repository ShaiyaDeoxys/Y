...
namespace Imgeneus.World
{
    public sealed class WorldClient : ServerClient, IWorldClient
    {
        ...
        private readonly Dictionary<PacketType, PacketDeserializeHandler> _packetHandlers = new Dictionary<PacketType, PacketDeserializeHandler>()
        {
            ...
            { PacketType.CHARACTER_TELEPORT_VIA_NPC, (s) => new CharacterTeleportViaNpcPacket(s) },
            ...
            { PacketType.GM_SHAIYA_US_CREATE_MOB, (s) => new GMCreateMobPacket(s) },
            ...
            { PacketType.TRADE_REMOVE_ITEM, (s) => new TradeRemoveItemPacket(s) },
            ...
            { PacketType.USE_ITEM_2, (s) => new UseItem2Packet(s) },
            ...
            { PacketType.USE_VEHICLE_2, (s) => new UseVehicle2Packet(s) },
            { PacketType.VEHICLE_REQUEST, (s) => new VehicleRequestPacket(s) },
            { PacketType.VEHICLE_RESPONSE, (s) => new VehicleResponsePacket(s) },
            ...
            { PacketType.GM_SHAIYA_US_ATTRIBUTE_SET, (s) => new GMSetAttributePacket(s) },
            ...
            { PacketType.GUILD_NPC_UPGRADE, (s) => new GuildNpcUpgradePacket(s) },
            { PacketType.GUILD_ETIN_RETURN, (s) => new GuildEtinReturnPacket(s) }
        };
